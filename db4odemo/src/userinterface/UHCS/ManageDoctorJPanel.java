...
public class ManageDoctorJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageDoctorJPanel(JPanel userProcessContainer, UserAccount account, EcoSystem system) {
        initComponents();
    ...
    private void btnInBucketPageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInBucketPageActionPerformed
        ...
        userProcessContainer.add("Doctor InBucket Complaints",page);
    ...
    private void btnOldPageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOldPageActionPerformed
        CompletedDoctorJPanel page = new CompletedDoctorJPanel(userProcessContainer,account,system);
        userProcessContainer.add("Doctor Old Complaints",page);
        CardLayout layout=(CardLayout)userProcessContainer.getLayout();
        layout.next(userProcessContainer);
