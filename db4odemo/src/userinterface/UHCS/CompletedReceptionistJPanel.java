 ...
 */
public class CompletedReceptionistJPanel extends javax.swing.JPanel {
     ...
     */
    public CompletedReceptionistJPanel(JPanel userProcessContainer, UserAccount account, EcoSystem system)  {
        initComponents();
    ...
    public void populateTable () {
        ...
        for(Complaint complaintWorkRequest : complaintListWorkQueue){
            ...
            if (complaintWorkRequest.getStatus()!=null && complaintWorkRequest.getStatus().startsWith("UHCS")) {
                ...
                if (complaintWorkRequest.getStatus().equals("UHCS Completed") || !complaintWorkRequest.getStatus().startsWith("UHCS")) {
    ...
    private void initComponents() {
        ...
        add(lblTitle);
        lblTitle.setBounds(4, 70, 970, 59);
        ...
        btnRefreshStatus.setBounds(830, 190, 110, 29);
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(30, 240, 916, 100);
